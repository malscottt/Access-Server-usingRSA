...
* [GMI-CTF](ctf-writeups/gmi-ctf.md)
...
* [Powershell Cobalt Strike Beacon](threat-hunting/powershell-cobalt-strike-beacon.md)

## ANDROID

* [Pentesting Android using PentestBox](android/pentesting-android-using-pentestbox.md)

## LINK

* [Difference between Firewall & NG Firewall](link/difference-between-firewall-and-ng-firewall.md)
* [400 vs 500 status code](https://javascript.plainenglish.io/getting-to-know-http-400-vs-500-status-error-codes-2ce5bf1a7cb3)
